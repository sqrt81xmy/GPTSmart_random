...
def deal_smartian_fuzzer(data,filename,tmpDir,mainContract,datasetName,outputDir,timeLimit,messages):
        ...
        cmd_str_build = "dotnet build /home/test/tools/GPTSmart_random/Smartian/src/Smartian.fsproj"
        cmd_str_exec = "dotnet /home/test/tools/GPTSmart_random/Smartian/src/bin/Debug/net8.0/Smartian.dll fuzz " \
